...
class MaskFormerHead(AnchorFreeHead):
    ...
    def __init__(self,
        ...
        if train_cfg:
            ...
            self.sampler = build_sampler(train_cfg.get('sampler', None),
                                         context=self)
    ...
    def loss_single(self, cls_scores, mask_preds, gt_labels_list,
        ...
        # shape (num_total_gts, h, w)
        mask_preds = F.interpolate(mask_preds.unsqueeze(1),
                                   target_shape,
                                   mode='bilinear',
                                   align_corners=False).squeeze(1)

        # dice loss
        loss_dice = self.loss_dice(mask_preds,
                                   mask_targets,
        ...
        loss_mask = self.loss_mask(mask_preds,
                                   1 - mask_targets,
