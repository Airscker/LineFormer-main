...
class MaskFormerFusionHead(BasePanopticFusionHead):
    ...
    def simple_test(self,
        ...
        results = []
        # print(len(mask_cls_results), len(mask_pred_results), len(img_metas))
        for mask_cls_result, mask_pred_result, meta in zip(
            ...
            if rescale:
                ...
                mask_pred_result = F.interpolate(mask_pred_result[:, None],
